...
void GeometryClass::CreatePlane(ID3D11Device *dev, ID3D11DeviceContext *devcon, float y, string name)
{
	...
	VERTEX vert1 = {D3DXVECTOR3(-30.0f, y, -30.0f),ground, D3DXVECTOR3(0.0f, 1.0f, 0.0f), D3DXVECTOR2(10.0f,10.0f)};
    VERTEX vert2 = {D3DXVECTOR3(-30.0f, y, 30.0f),ground, D3DXVECTOR3(0.0f, 1.0f, 0.0f), D3DXVECTOR2(10.0f,0.0f)};
    VERTEX vert3 = {D3DXVECTOR3(30.0f, y, 30.0f),ground, D3DXVECTOR3(0.0f, 1.0f, 0.0f), D3DXVECTOR2(0.0f,0.0f)};
	VERTEX vert4 = {D3DXVECTOR3(30.0f, y, -30.0f),ground, D3DXVECTOR3(0.0f, 1.0f, 0.0f), D3DXVECTOR2(0.0f,10.0f)};
