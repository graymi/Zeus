...
bool ModelClass::InitializeBuffers(ID3D11Device* device)
{
    ...
    // Draw a quad
    VertexType quad1;
    quad1.position = D3DXVECTOR3(-3.5f, 1.0f, 1.0f);
    quad1.color = D3DXVECTOR4(0.0f, 0.0f, 1.0f, 0.5f);
    quad1.normal = D3DXVECTOR3(0.0f, 0.0f, 1.0f);
    VertexType quad2;
    quad2.position = D3DXVECTOR3(-1.5f, -1.0f, 0.8f);
    quad2.color = D3DXVECTOR4(0.0f, 0.0f, 1.0f, 0.5f);
